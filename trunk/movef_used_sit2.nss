...
void main()
{
    ...
    object oPillow1 = GetLocalObject( OBJECT_SELF, "movef_used_sit2_Pillow1" );
    object oPillow2 = GetLocalObject( OBJECT_SELF, "movef_used_sit2_Pillow2" );
    ...
    if( !GetIsObjectValid( oPillow1 ) )
    {
        ...
        // Memorise les places
        SetLocalObject( OBJECT_SELF, "movef_used_sit2_Pillow1", oPillow1 );
        SetLocalObject( OBJECT_SELF, "movef_used_sit2_Pillow2", oPillow2 );
    }
