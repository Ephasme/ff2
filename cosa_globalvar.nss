...
// DEF IN "cosa_globalvar"
// Fonction qui stocke les données de l'évènement OnEnter en variable
// globale.
//   > object oEnteringObject - Resultat de GetOnEnteringObject().
void cosSaveOnEnter(object oEnteringObject);

// DEF IN "cosa_globalvar"
// Fonction qui recupere les données de l'évènement OnEnter.
//   o object - Resultat de GetOnEnteringObject().
